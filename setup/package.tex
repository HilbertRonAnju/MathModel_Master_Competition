...
\setCJKfamilyfont{Huawei}[Path=fonts/]{HuaWei.TTF}
\newcommand{\huawei}{\CJKfamily{Huawei}}
\setCJKfamilyfont{simli}[Path=fonts/]{SIMLI.TTF}
\newcommand{\simli}{\CJKfamily{simli}}
